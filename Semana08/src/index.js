...
// express session - ESTÁ EXECUTANDO EM MEMÓRIA
// OUTRO PROBLEMA QUANDO EXECUTADO EM MEMÓRIA É ESCALAR A APLICAÇÃO HORIZONTALMENTE
app.use(session({
...
// MIDDLEWARE - FUNCAO QUE EXECUTA ENTRE O REQUEST E O RESPONSE
